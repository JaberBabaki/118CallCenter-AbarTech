...
public class MyReceiver extends BroadcastReceiver {
    ...
    private long       interval = 60 * 1000 * 120;
                                    ...
                                    for (int i = 0; i < array.length(); i++) {
                                        ...
                                        if ((noti.selectId() == 0)) {
                                            ...
                                            mBuilder.setContentTitle(title)
                                                    .setContentText(text)
                                                    .setSmallIcon(R.drawable.ic_launcher_notific)
                    ...
                    new Response.Listener<String>()
                    {
                        ...
                        public void onResponse(final String response) {
                            ...
                            if ( !response.equals("")) {
                                ...
                                Intent intent = new Intent(context, Call118Activity.class);
                                PendingIntent contentIntent = PendingIntent.getActivity(context, 1, intent, 0);

                                mBuilder.setContentTitle(" اپلیکشن 118 مازندران ")
