...
public class AdapterLitOstanForSync extends ArrayAdapter<StructHa> {

    public AdapterLitOstanForSync(ArrayList<StructHa> array) {
        ...
        public void fill(ArrayAdapter<StructHa> adapter, final StructHa item, int position) {
            ...
            txtNameStore.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    G.btnShharSynce.setText(txtNameStore.getText().toString());
